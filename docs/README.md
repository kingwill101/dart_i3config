...
- **[Language Guide](language-guide.md)** - Complete language syntax and API reference
...
The library provides a state machine architecture with handler-based processing, scoped commands, variable expansion, and advanced configuration manipulation capabilities.
