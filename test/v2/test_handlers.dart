...
class BarBlockHandler with ValueExpander implements BlockHandler {
  @override
...
class ModeBlockHandler with ValueExpander implements BlockHandler {
  @override
...
class ModeBindsymHandler with ValueExpander implements CommandHandler {
  ...
  void handle(Command command, ProcessingContext context) {
    if (command.args.length >= 2) {
      ...
      final modeBindings = globalContext.options['mode_bindings'] as Map<String, String>? ?? <String, String>{};
