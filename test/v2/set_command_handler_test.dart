...
void main() {
  group('SetCommandHandler (Built-in)', () {
    test('should set simple variable', () {
    ...
    test('should set variable with quoted value', () {
    ...
    test('should set variable with bare argument', () {
    ...
    test('should expand variable references in values', () {
      final configContent = '''
...
''';
    ...
    test('should handle multiple variable assignments', () {
      final configContent = '''
set \$mod Mod4
...
''';
    ...
    test('should expand variables in bare argument values', () {
      final configContent = '''
set \$mod Mod4
set \$key_prefix \$mod
''';
    ...
    test('should handle commands with insufficient args gracefully', () {
    ...
    test('should only process VariableRef as first argument', () {
    ...
    test('should expand variables in quoted strings', () {
      final configContent = '''
set \$user alice
...
''';
    ...
    test('should make global variables available inside blocks', () {
      final configContent = '''
...
''';
      ...
      expect(processor.context.getVariable('global_var'), equals('global_value'));
      expect(processor.context.getVariable('another_global'), equals('another_value'));
      
      // Verify the block command saw the expanded global variable
      expect(capturedValues, contains('global_value'));
    });

    test('should allow blocks to shadow global variables', () {
      final configContent = '''
set \$var "global"
bar {
    set \$var "block_local"
...
''';
    ...
    test('should allow referencing global variables from block context', () {
      final configContent = '''
set \$base "base_value"
bar {
    set \$derived \$base
...
class _TrackingBarBlockHandler implements BlockHandler {
