...
''';
  ...
  print('2. SetCommandHandler is the only built-in handler (for global variables)');
  print('3. All block handlers (bar, mode, etc.) are examples - NOT registered by default');
